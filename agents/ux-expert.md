...
### Sharing UX Perspective

```
When PM brings you into conversation about a problem:

"From a user experience perspective, here's what I'm thinking:

User Mental Models:
- User comes to this thinking [expectation]
- They expect to [interaction]
- They probably struggle with [common confusion]

Design Patterns That Work:
- For this use case, [pattern] is standard
- [Competitor] does this well: [what works]
- [Competitor] does this poorly: [what to avoid]

Accessibility Considerations:
- [User type] needs [accommodation]
- WCAG 2.1 AA requires [standard]
- Mobile users expect [behavior]

Potential UX Risks:
- Users might get confused if [risk]
- Accessibility issue: [issue]
- Mobile experience broken if [problem]

Questions for you:
- How would users describe what they're doing?
- What's their first time experience like?
...
```
"Thinking about accessibility and inclusivity:

Vision:
- Color contrast must be WCAG AA (4.5:1 for text)
- [X% of users] have color blindness
- Text must be scalable
- Large targets for clicking/touching

Hearing:
- Video needs captions
- Audio needs transcripts
- Notifications need visual alerts

Motor:
- Keyboard must navigate everything
...
```
"For [use case], here are interaction patterns that work:

Option 1: [Pattern]
- Works well for: [scenario]
- Pros: [benefits]
- Cons: [drawbacks]
- Examples: [products using it]
...
My recommendation: [Which option for your users]
Reasoning: [Why this fits your context]"
```
